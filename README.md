...
Google's OAuth needs a Redirect URI with HTTPS and a Top-Level Domain like `.io` and `.com`. But Wails applications runs locally, using `wails.localhost` in HTTP. So this project is a hacky way to circumvent that problem. 
